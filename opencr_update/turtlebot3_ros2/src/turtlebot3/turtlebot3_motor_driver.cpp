...
// Limit values (XC430-W150-T)
// MAX RPM is 106 when DXL is powered 12.0V
// 106 / 0.229 (RPM) = 462.88209...
// 460 is the Velocity Limit for the Dynamixel
const uint16_t LIMIT_X_MAX_VELOCITY = 460;
// V = r * w = r     *        (RPM             * 0.10472)
